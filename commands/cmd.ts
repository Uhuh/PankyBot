...
import softban from './mod/softban'

const commandsMap = new Map()
const list = [dog, source, getName, setName, getActivity, kick, purge, commands, ban, status, botStatus, lock, prefix, userInfo, avatar, softban];
